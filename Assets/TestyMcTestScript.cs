...
public class TestyMcTestScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (_CrabSizeManager == null) Debug.Log("COULDN'T FIND THE CRAB SIZE MANAGER!!!");
    ...
    {
        /*
        if (Input.GetKeyDown(KeyCode.I)) Debug.Log(_CrabSizeManager.GetCrabXP().ToString() + " Experience");
        if (Input.GetKeyDown(KeyCode.K)) Debug.Log(_CrabSizeManager.GetCrabSize().ToString() + " is current size");
